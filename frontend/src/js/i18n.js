...
const i18nDict = {
    ...
    firstName:        { ar: 'الاسم الأول بالعربية',        en: 'First Name (in Arabic)' },
    firstNamePlaceholder: { ar: 'مثلا: محمد',              en: 'محمد' },
    lastName:         { ar: 'الاسم الأخير بالعربية',       en: 'Last Name (in Arabic)' },
    lastNamePlaceholder:  { ar: 'مثلا: احمد',              en: 'احمد' },
    ...
    errArabicName:    { ar: 'برجاء كتابة الاسم باللغة العربية', en: 'Please write your name in Arabic' },
