...
class User(Base):
    ...
    # **متوقّفة من 2026-09-06.** كانت المخرج «اسمي مش بالعربي»: العضو يعلّمها
    # فيتخزّن اسمه اللاتيني والسؤال يسكت. المالك شال المخرج — الاسم بالعربي
    # بقى مطلوب من غير استثناء في كل باب بيعمل حساب جديد.
    #
    # العمود فاضل مكانه عن قصد: صف واحد بس اتعلّم عليه فعلاً، وهو سجل إن
    # الحساب ده اتعمل أيام ما المخرج كان موجود. مفيش كود بيكتب فيه دلوقتي،
    # ومحدش بيقرأه في أي قرار — `needs_arabic_name` بقت على الاسم وبس. مسحه
    # كان هيمسح الحقيقة دي من غير ما يكسب حاجة.
    #
